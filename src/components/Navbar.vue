...
<template>
   <nav style="margin-bottom: 100px;" class="bg-gray-800">
    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <div class=" text-white rounded-md px-3 py-2 text-sm font-medium" style="font-weight: bolder;" >TRACKER</div>
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <RouterLink to="/">
            <div class="hover:bg-gray-700 hover:text-white text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</div>
            </RouterLink>
          
            
            <RouterLink v-if="isLoggedOn" to="/view-all-applications">
            <div  class="hover:bg-gray-700 hover:text-white text-white rounded-md px-3 py-2 text-sm font-medium">Applications</div>
          </RouterLink>

          <a @click="toggleDropdown2" v-if="isLoggedOn" href="#">
            <div  class="relative hover:bg-gray-700 hover:text-white text-white rounded-md px-3 py-2 text-sm font-medium"> Job Posting
              <div v-if="showDropdown2" style="left: 0px;" class="absolute z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
            <!-- Active: "bg-gray-100", Not Active: "" -->

            <RouterLink to="/add-job-posting">
              <div class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Add Job Posting</div>
            </RouterLink>
            <!-- <RouterLink to="/view-all-jobs">
              <div class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">View All Job Posting</div>
            </RouterLink> -->
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div v-if="isLoggedOn" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Hi {{name}}</div>
